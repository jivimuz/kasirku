...
function displaya_errors($erroreuys){
  $displaya='';
  foreach ($erroreuys as $errora) {
  $displaya .= '<div class="col-md-2 alert alert-warning alert-dismissable" role="alert">';
   $displaya .= '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
   $displaya .= '<font style="font-style: italic; font-size:10px;">'.$errora."</font></div>&nbsp;&nbsp;";
 }
 return $displaya;
}
...
function resize_png($originalFile, $targetFile, $width = NULL, $height = NULL) {
